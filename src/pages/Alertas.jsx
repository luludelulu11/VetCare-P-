...
export default function Alertas() {
  ...
  useEffect(() => {
    const loadAlertas = async () => {
      ...
      setStats({
        overdue: demoAlertas.filter((a) => a.categoria === "overdue").length,
        today: demoAlertas.filter((a) => a.categoria === "today").length,
        tomorrow: demoAlertas.filter((a) => a.categoria === "tomorrow").length,
        upcoming: demoAlertas.filter((a) => a.categoria === "upcoming").length,
      });
      setLoading(false);
      return;
  }
